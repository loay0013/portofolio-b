...
<div class="has-text-centered hero-body mt-6">
    <figure class="image is-inline-block">
        <img src="images/dijlogofooterhvid.svg" alt="logo">
    </figure>
</div>
<div >
    <h1 class="has-text-light p-4 has-text-centered mt-5 mb-5">
        Din Indre Juvel
    </h1>
</div>
<!-- Link to website -->
<div class="has-text-centered mt-5 mb-5">
    <a class="has-text-link" href="https://github.com/loay0013/dinindrejuvel" target="_blank">
...
<div class="container mt-5 mb-5">
    <p class="has-text-light mt-4 p-4">
        I dette projekt tog jeg udfordringen op at bygge en hjemmeside fra bunden for "Din Indre Juvel blog",
...
<div class="has-text-centered pb-5 mt-5 mb-5">
    <a class="næste" href="Musik.php">
        <h2>>/Næste projekt></h2>
    </a>
</div>
</div>
